...
public class MultiThreadedSimpleServer {
    public static void main(String[] args) {
        ...
        try(ServerSocket serverSocket = new ServerSocket(5000)){
            while(true){
                ...
                socket.setSoTimeout((900_0000));//Sera bloquer en attendant un stream de donner pendant le nombre de seconde renseigné
    ...
    private static void handleClientRequest(Socket socket){
        ...
        try(
            ...
            System.out.println("Client socket shut down"+e.getMessage());
        }
    }
}
